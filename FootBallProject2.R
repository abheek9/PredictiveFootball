...
trainData = premData[premData$Season < 2000,]
...
testData = premData[premData$Season>=2000,]
testData = testData[testData$tier == 1,]
testData = testData[testData$Season < 2010,]
...
write.csv(testData, "testDataAllTeamSameElo2.csv")
...
write.csv(testData, "testDataDifferentEloTier2.csv")
